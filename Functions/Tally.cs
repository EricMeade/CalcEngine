...
namespace CalcEngine.Functions
{
    ...
    {
        private double _sum, _sum2, _cnt, _min, _max;
        ...
        {
            var avg = Average();
            return _cnt <= 1 ? 0 : System.Math.Sqrt(_sum2 / _cnt - avg * avg);
        }
        ...
        {
            var avg = Average();
            return _cnt <= 1 ? 0 : System.Math.Sqrt((_sum2 / _cnt - avg * avg) * _cnt / (_cnt - 1));
        }
    }
}